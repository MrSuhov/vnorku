...
export default function PartnersPage() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: 'Мы сами интегрируемся с вашим API — с вашей стороны не нужно никаких дополнительных действий',
    },
    {
      icon: CheckCircle,
      title: 'Без дополнительных затрат',
      description: 'Партнёрство полностью бесплатное',
    },
  ];
  ...
  const requirements = [
    {
      ...
      description: 'Методы поиска товаров в привязке к адресу покупателя, включающие текущие условия доставки по указанному адресу',
      status: 'required',
    },
    {
      title: 'Поддержка глубоких ссылок (Deep Links)',
      description: 'Для экономии времени пользователя преимуществом является возможность открыть ссылку на товар непосредственно в вашем приложении',
      status: 'optional',
    },
    {
      title: 'Данные о доставке',
      description: 'Информация о стоимости и условиях доставки в зависимости от адреса может быть передана как в составе API-ответа, если она динамическая и зависит от времени суток и текущей нагрузки на курьерскую службу, а может быть установлена статично',
      status: 'optional',
    },
  ];
